...
private _secgroup = [_spawnPoint,West,(configfile >> "CfgGroups" >> "West" >> "BLU_F" >> "Infantry" >> "BUS_InfSquad")] call BIS_fnc_spawnGroup;
(units _secgroup) joinSilent _supgroup;
private _unitsCargo = units _supgroup;
private _heli = createVehicle ["B_T_VTOL_01_infantry_F",_spawnPoint, [], 0, "FLY"];
...
_heli spawn _flares;
waitUntil {
(_heli distance _spawnLocation#1) < 700
};
